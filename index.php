          ...
          <div class="row p-3">
            ...
            <div class="col-6">              
              <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Баланс" aria-label="Баланс" aria-describedby="basic-addon2" readonly> <!--// вписали "readonly" чтоб в балансе нельзя было вводить сумму вручную, только посредством внесения денег-->
                <div class="input-group-append"> <!--окно баланса-->
                  <span class="input-group-text" id="basic-addon2">&#8381;</span> <!--значок рубля-->
                </div>
              </div>
              <div class="atm">
                <img src="img/bill_acc.png" alt=""> <!--приёмник денег-->
              </div>
